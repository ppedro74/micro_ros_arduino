...
if [[ " ${PLATFORMS[@]} " =~ " teensy36 " ]]; then
    ...
    export TOOLCHAIN_PREFIX=/uros_ws/gcc-arm-none-eabi-5_4-2016q3/bin/arm-none-eabi-
    ros2 run micro_ros_setup build_firmware.sh /project/extras/library_generation/teensy36_toolchain.cmake /project/extras/library_generation/colcon_lowmem.meta
